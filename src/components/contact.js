...
function Contact(props) {
  ...
  return (
    <div className="">
        ...
        <div className="col-lg-6">
          ...
          <form ref={form} onSubmit={sendEmail}>
            ...
            <div className="mb-3">
              ...
              <textarea className="form-control" placeholder="Texto" name="message"></textarea>
            </div>
      ...
      <div className={`toast align-items-center text-white bg-success border-0 ${showToastError ? 'show' : ''}`} role="alert" aria-live="assertive" aria-atomic="true">
        <div className="d-flex">
          <div className="toast-body">
